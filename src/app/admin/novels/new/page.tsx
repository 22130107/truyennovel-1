  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-black tracking-tight">Thêm truyện mới</h1>
          <p className="text-black mt-1">Nhập thông tin chi tiết để thêm một bộ truyện mới vào hệ thống.</p>
        </div>
      </div>
