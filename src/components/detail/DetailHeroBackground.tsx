...
export function DetailHeroBackground({ imageUrl, alt = "background" }: DetailHeroBackgroundProps) {
  return (
    <div className="overflow-hidden relative w-full h-[600px]">
      <img alt={alt} src={imageUrl} className="block size-full max-w-full object-cover object-top overflow-clip absolute align-middle left-0 top-0 right-0 bottom-0 text-black/0" />
      <div className="absolute left-0 top-0 right-0 bottom-0 bg-site/20"></div>
